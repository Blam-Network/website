...
export default async function CampaignCarnageReportPage({ params }: { params: { id: string } }) {
    ...
    const carnageReport = await api.ares.getCampaignCarnageReport.query({ id: params.id });
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 4 }}>
            ...
            {/* MVP Section */}
            <Box sx={{ mb: 4 }}>
                <MVPSection player={winner} playerRouteBase="/ares/player" />
            </Box>
