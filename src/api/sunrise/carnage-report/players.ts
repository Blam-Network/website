...
export const PlayerSchema = z.object({
  ...
  ban_flags: z.coerce.number(),
  gamer_zone: z.number(),
  is_griefer: z.number(),
  cheat_flags: z.coerce.number(),
  ...
  session_party_nonce: z.string().nullable().optional(),
  machine_host: z.boolean().nullable().optional(),
  machine_initial_host: z.boolean().nullable().optional(),
  ...
  bungienet_user_flags: z.coerce.number(),
  ...
  custom_games_completed: z.coerce.number(),
  emblem_secondary_color: z.number(),
  hopper_experience_base: z.coerce.number(),
  ...
  hopper_experience_penalty: z.coerce.number(),
  is_free_live_gold_account: z.boolean(),
  repeated_play_coefficient: z.number(),
  matchmade_ranked_games_won: z.coerce.number(),
  hopper_statistics_games_won: z.coerce.number(),
  hopper_statistics_identifier: z.number(),
  host_stats_global_experience: z.coerce.number(),
  campaign_difficulty_completed: z.number(),
  matchmade_ranked_games_played: z.coerce.number(),
  hopper_statistics_games_played: z.coerce.number(),
  hopper_statistics_hopper_skill: z.coerce.number(),
  global_statistics_highest_skill: z.coerce.number(),
  host_stats_hopper_skill_display: z.number(),
  is_user_created_content_allowed: z.boolean(),
  matchmade_unranked_games_played: z.coerce.number(),
  matchmade_ranked_games_completed: z.coerce.number(),
  global_statistics_experience_base: z.coerce.number(),
  hopper_statistics_games_completed: z.coerce.number(),
  is_friend_created_content_allowed: z.boolean(),
  matchmade_unranked_games_completed: z.coerce.number(),
  global_statistics_experience_penalty: z.coerce.number(),
